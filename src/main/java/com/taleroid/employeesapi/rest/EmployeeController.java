...
public class EmployeeController {
	...
	@DeleteMapping("/employees/{emplpyeeId}")
	public ResponseEntity<Object> deleteEmployee(@PathVariable int emplpyeeId) {
		Employee currentEmplpyee = employeeService.findById(emplpyeeId);
		...
		return ResponseEntity.status(HttpStatus.OK).body("Deleted employee: " + emplpyeeId);
	}
}
